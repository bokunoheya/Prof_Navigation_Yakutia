 ...
 * Use the {@link Vt#newInstance} factory method to
...
public class Vt extends Fragment {
    ...
    public static Vt newInstance(String param1, String param2) {
        Vt fragment = new Vt();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.vt, container, false);
      /*  Button info=root.findViewById(R.id.info_button);
        ...
        professii.setOnClickListener(Navigation.createNavigateOnClickListener(R.id.professiiVt));
        return root;
    }
}
