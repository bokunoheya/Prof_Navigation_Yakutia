 ...
 * Use the {@link S23_01_17#newInstance} factory method to
 * create an instance of this fragment.
 */
public class S23_01_17 extends Fragment {
    ...
    public static S23_01_17 newInstance(String param1, String param2) {
        S23_01_17 fragment = new S23_01_17();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.fragment_s23_01_17, container, false);
        ...
        TextView lvl_pp=root.findViewById(R.id.textView50);
        ...
        switch(MainActivity.item){
            ...
            case "mrtk":
                ...
                break;
            case "pc":
                lvl_pp.setText(R.string.lvl_ppkris);
                lvl.setText(R.string.minus);
                mestoO9.setText(R.string.m50);
                break;
        }
        return root;
    }
