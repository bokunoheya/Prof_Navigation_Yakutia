 ...
 * Use the {@link S43_02_01#newInstance} factory method to
 * create an instance of this fragment.
 */
public class S43_02_01 extends Fragment {
    ...
    public static S43_02_01 newInstance(String param1, String param2) {
        S43_02_01 fragment = new S43_02_01();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.fragment_s43_02_01, container, false);
        ...
        switch(MainActivity.item){
            ...
            case "ytek":
                ...
                srok11.setText(R.string.srok_2_10);
                mesto11b.setText(R.string.budjet_m25);
                mesto11c.setText(R.string.com_osn_m5);
                break;
            case "ytts":
                lvl.setText(R.string.minus);
                srok11.setText(R.string.srok_2_10);
                mesto11b.setText(R.string.budjet_m25);
                /*----------------------------*/
                srok9.setText(R.string.minus);
                mesto9b.setText(R.string.minus);
                break;
        }
        return root;
    }
