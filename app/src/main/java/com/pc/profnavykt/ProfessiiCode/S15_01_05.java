 ...
 * Use the {@link S15_01_05#newInstance} factory method to
 * create an instance of this fragment.
 */
public class S15_01_05 extends Fragment {
     ...
     * @return A new instance of fragment S15_01_05.
     */
    // TODO: Rename and change types and number of parameters
    public static S15_01_05 newInstance(String param1, String param2) {
        S15_01_05 fragment = new S15_01_05();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.fragment_s15_01_05, container, false);
        ...
        switch(MainActivity.item){
            ...
            case "zt":
            case "ggt":
                srokO9.setText(R.string.srok_2_10);//2 года 10 мес
                mestoO9.setText(R.string.budjet_m25);
                break;
            case "zml":
                srokO11.setText(R.string.srok_2_10);
                mestoO11.setText(R.string.budjet_m12);
                break;
            case "mrtk":
                srokO9.setText(R.string.srok_2_10);
                mestoO9.setText(R.string.budjet_m40);
                break;
            case "pc":
                srokO11.setText(R.string.srok_10);
                break;
        }
        return root;
    }
