 ...
 * Use the {@link Rti#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Rti extends Fragment {
    ...
    public static Rti newInstance(String param1, String param2) {
        Rti fragment = new Rti();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.rti, container, false);
      /*  Button info=root.findViewById(R.id.info_button);
        ...
        professii.setOnClickListener(Navigation.createNavigateOnClickListener(R.id.professiiRti));
        return root;
    }
}
