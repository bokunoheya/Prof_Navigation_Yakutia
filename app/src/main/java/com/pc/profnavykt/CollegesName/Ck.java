 ...
 * Use the {@link Ck#newInstance} factory method to
...
public class Ck extends Fragment {
    ...
    public static Ck newInstance(String param1, String param2) {
        Ck fragment = new Ck();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.ck, container, false);
      /*  Button info=root.findViewById(R.id.info_button);
        ...
        professii.setOnClickListener(Navigation.createNavigateOnClickListener(R.id.professiiCk));
        return root;
    }
}
