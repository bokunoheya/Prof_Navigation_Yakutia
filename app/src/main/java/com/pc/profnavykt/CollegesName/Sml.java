 ...
 * Use the {@link Sml#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Sml extends Fragment {
    ...
    public static Sml newInstance(String param1, String param2) {
        Sml fragment = new Sml();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.sml, container, false);
      /*  Button info=root.findViewById(R.id.info_button);
        ...
        professii.setOnClickListener(Navigation.createNavigateOnClickListener(R.id.professiiSml));
        return root;
    }
}
