 ...
 * Use the {@link Uat#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Uat extends Fragment {
    ...
    public static Uat newInstance(String param1, String param2) {
        Uat fragment = new Uat();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.uat, container, false);
      /*  Button info=root.findViewById(R.id.info_button);
        ...
        professii.setOnClickListener(Navigation.createNavigateOnClickListener(R.id.professiiUat));
        return root;
    }
}
