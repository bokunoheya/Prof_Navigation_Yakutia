 ...
 * Use the {@link Tt#newInstance} factory method to
...
public class Tt extends Fragment {
    ...
    public static Tt newInstance(String param1, String param2) {
        Tt fragment = new Tt();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.tt, container, false);
      /*  Button info=root.findViewById(R.id.info_button);
        ...
        professii.setOnClickListener(Navigation.createNavigateOnClickListener(R.id.professiiTt));
        return root;
    }
}
