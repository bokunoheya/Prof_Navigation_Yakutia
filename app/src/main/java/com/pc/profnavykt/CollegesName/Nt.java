 ...
 * Use the {@link Nt#newInstance} factory method to
...
public class Nt extends Fragment {
    ...
    public static Nt newInstance(String param1, String param2) {
        Nt fragment = new Nt();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.nt, container, false);
      /*  Button info=root.findViewById(R.id.info_button);
        ...
        professii.setOnClickListener(Navigation.createNavigateOnClickListener(R.id.professiiNt));
        return root;
    }
}
