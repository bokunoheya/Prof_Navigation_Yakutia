 ...
 * Use the {@link Vml#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Vml extends Fragment {
    ...
    public static Vml newInstance(String param1, String param2) {
        Vml fragment = new Vml();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.vml, container, false);
      /*  Button info=root.findViewById(R.id.info_button);
        ...
        professii.setOnClickListener(Navigation.createNavigateOnClickListener(R.id.professiiVml));
        return root;
    }
}
