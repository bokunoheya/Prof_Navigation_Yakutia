 ...
 * Use the {@link ProfessiiTt#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ProfessiiTt extends Fragment {
...
public static String stroke="tt";
    ...
    public static ProfessiiTt newInstance(String param1, String param2) {
        ProfessiiTt fragment = new ProfessiiTt();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.fragment_professii_tt, container, false);
        ...
        button3.setOnClickListener(Navigation.createNavigateOnClickListener(R.id.s08_02_10));
        Button button4=root.findViewById(R.id.button4);
        button4.setOnClickListener(Navigation.createNavigateOnClickListener(R.id.s23_02_01));
        Button button5=root.findViewById(R.id.button5);
        button5.setOnClickListener(Navigation.createNavigateOnClickListener(R.id.s23_02_06));
