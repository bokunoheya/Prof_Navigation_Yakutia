...
public class ProfessiiPc extends Fragment {
    ...
    public static String stroke="pc";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        button5.setOnClickListener(Navigation.createNavigateOnClickListener(R.id.s22_02_06));
        Button button6=root.findViewById(R.id.button6);
        button6.setOnClickListener(Navigation.createNavigateOnClickListener(R.id.s23_01_17));
