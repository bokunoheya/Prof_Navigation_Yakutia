 ...
 * Use the {@link ProfessiiZt#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ProfessiiZt extends Fragment {
    // TODO: Rename parameter arguments, choose names that match
    // the fragment initialization parameters, e.g. ARG_ITEM_NUMBER
    private static final String ARG_PARAM1 = "param1";
    private static final String ARG_PARAM2 = "param2";
    public static String stroke="zt";
    ...
    public static ProfessiiZt newInstance(String param1, String param2) {
        ProfessiiZt fragment = new ProfessiiZt();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.fragment_professii_zt, container, false);
        ...
        button3.setOnClickListener(Navigation.createNavigateOnClickListener(R.id.s26_02_03));
        Button button4=root.findViewById(R.id.button4);
        button4.setOnClickListener(Navigation.createNavigateOnClickListener(R.id.s26_01_01));
        Button button5=root.findViewById(R.id.button5);
        button5.setOnClickListener(Navigation.createNavigateOnClickListener(R.id.s34_02_02));
