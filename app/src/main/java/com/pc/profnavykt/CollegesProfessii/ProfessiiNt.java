...
public class ProfessiiNt extends Fragment {
    ...
    public static String stroke="nt";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       Button button3=root.findViewById(R.id.button3);
        button3.setOnClickListener(Navigation.createNavigateOnClickListener(R.id.s05_01_01));
    //38_01_02 истинный код специальности
    /*    switch(stroke){
            case 1:     Button button3=root.findViewById(R.id.button3);
                button3.setOnClickListener(Navigation.createNavigateOnClickListener(R.id.s05_01_01));
                stroke=0;
                break;
            case 0: stroke=1;
